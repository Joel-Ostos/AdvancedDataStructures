...
int main() {
    ...
    std::cout << "\n=== Compilation Instructions ===" << std::endl;
    std::cout << "To compile with nodeTree (default):" << std::endl;
    std::cout << "g++ -std=c++11 -o avl_test avl_example.cpp" << std::endl;
    std::cout << "\nTo compile with leafTree:" << std::endl;
    std::cout << "g++ -std=c++11 -DUSE_LEAF_TREE -o avl_test avl_example.cpp" << std::endl;
